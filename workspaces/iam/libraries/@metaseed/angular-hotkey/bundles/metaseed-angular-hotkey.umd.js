(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('tslib'), require('rxjs'), require('mousetrap'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@metaseed/angular-hotkey', ['exports', '@angular/core', 'tslib', 'rxjs', 'mousetrap', '@angular/common'], factory) :
    (factory((global.metaseed = global.metaseed || {}, global.metaseed['angular-hotkey'] = {}),global.ng.core,global.tslib,null,null,global.ng.common));
}(this, (function (exports,core,tslib,rxjs,mousetrap,common) { 'use strict';
    ...
    var HotkeysService = (function () {
        ...
        HotkeysService.prototype.add = function (hotkey, specificEvent) {
            ...
            if (Array.isArray(hotkey)) {
                var /** @type {?} */ temp = [];
                try {
                    for (var hotkey_1 = tslib.__values(hotkey), hotkey_1_1 = hotkey_1.next(); !hotkey_1_1.done; hotkey_1_1 = hotkey_1.next()) {
                    ...
                    try {
                        if (hotkey_1_1 && !hotkey_1_1.done && (_a = hotkey_1.return))
                            _a.call(hotkey_1);
                    }
                    finally {
                        if (e_1)
        ...
        HotkeysService.prototype.remove = function (hotkey) {
            ...
            if (!hotkey) {
                try {
                    for (var _a = tslib.__values(this.hotkeys), _b = _a.next(); !_b.done; _b = _a.next()) {
                        var key = _b.value;
            ...
            if (Array.isArray(hotkey)) {
                try {
                    for (var hotkey_2 = tslib.__values(hotkey), hotkey_2_1 = hotkey_2.next(); !hotkey_2_1.done; hotkey_2_1 = hotkey_2.next()) {
                    ...
                    try {
                        if (hotkey_2_1 && !hotkey_2_1.done && (_d = hotkey_2.return))
                            _d.call(hotkey_2);
                    }
                    finally {
                        if (e_3)
        ...
        HotkeysService.prototype.get = function (combo) {
            ...
            if (Array.isArray(combo)) {
                var /** @type {?} */ temp = [];
                try {
                    for (var combo_1 = tslib.__values(combo), combo_1_1 = combo_1.next(); !combo_1_1.done; combo_1_1 = combo_1.next()) {
                    ...
                    try {
                        if (combo_1_1 && !combo_1_1.done && (_a = combo_1.return))
                            _a.call(combo_1);
                    }
                    finally {
                        if (e_4)
        ...
        HotkeysService.prototype.pause = function (hotkey) {
            ...
            if (Array.isArray(hotkey)) {
                var /** @type {?} */ temp = [];
                try {
                    for (var hotkey_3 = tslib.__values(hotkey), hotkey_3_1 = hotkey_3.next(); !hotkey_3_1.done; hotkey_3_1 = hotkey_3.next()) {
                    ...
                    try {
                        if (hotkey_3_1 && !hotkey_3_1.done && (_a = hotkey_3.return))
                            _a.call(hotkey_3);
                    }
                    finally {
                        if (e_5)
        ...
        HotkeysService.prototype.unpause = function (hotkey) {
            ...
            if (Array.isArray(hotkey)) {
                var /** @type {?} */ temp = [];
                try {
                    for (var hotkey_4 = tslib.__values(hotkey), hotkey_4_1 = hotkey_4.next(); !hotkey_4_1.done; hotkey_4_1 = hotkey_4.next()) {
                    ...
                    try {
                        if (hotkey_4_1 && !hotkey_4_1.done && (_a = hotkey_4.return))
                            _a.call(hotkey_4);
                    }
                    finally {
                        if (e_6)
    ...
    /** @nocollapse */
    HotkeysService.ctorParameters = function () {
        return [
    ...
    /** @nocollapse */
    CheatSheetComponent.ctorParameters = function () {
        return [
            { type: HotkeysService, },
        ];
    };
    ...
    var HotkeysDirective = (function () {
        ...
        HotkeysDirective.prototype.ngOnDestroy = function () {
            try {
                for (var _a = tslib.__values(this.hotkeysList), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var hotkey = _b.value;
                    this.mousetrap.unbind(hotkey.combo);
                }
            }
    ...
    /** @nocollapse */
    HotkeysDirective.ctorParameters = function () {
        return [
            { type: HotkeysService, },
...
//# sourceMappingURL=metaseed-angular-hotkey.umd.js.map
