...
export const adapter: EntityAdapter<Document> = createEntityAdapter<Document>({selectId:e=>e.number, sortComparer: (a: Document, b: Document)=> a.metaData && a.metaData.updated_at <  b.metaData.updated_at?1:-1});
