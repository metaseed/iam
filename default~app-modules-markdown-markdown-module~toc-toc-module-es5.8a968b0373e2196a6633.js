...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~app-modules-markdown-markdown-module~toc-toc-module"], {
  ...
  /***/
  function srcAppModulesMarkdownViewerElementsTocTocComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_toc_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/icon.js"); // rxjs 6
    ...
    function TocComponent_div_0_div_1_button_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TocComponent_div_0_div_1_button_2_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3);

          return ctx_r7.toggle(false);
        });
    ...
    function TocComponent_div_0_div_1_ng_container_4_li_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TocComponent_div_0_div_1_ng_container_4_li_1_Template_div_click_2_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);

          var toc_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3);

          return ctx_r13.navigate(toc_r9.href);
        });
      ...
      if (rf & 2) {
        ...
        var toc_r9 = ctx_r16.$implicit;
        var i_r10 = ctx_r16.index;
    ...
    function TocComponent_div_0_div_1_button_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TocComponent_div_0_div_1_button_5_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r18);

          var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3);

          return ctx_r17.toggle();
        });
    ...
    function TocComponent_button_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TocComponent_button_1_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20);

          var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r19.toggleToc();
        });
    ...
    var TocComponent = /*@__PURE__*/function () {
      var TocComponent = /*#__PURE__*/function () {
        function TocComponent(bm, scrollService, tocService, elementRef, location) {
          var _this = this;
          ...
          this.primaryMax = 4;
          bm.observe([_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].Small, _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].XSmall]).subscribe(function (state) {
            if (state.matches) {
              _this.show = false;
        ...
        _createClass(TocComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.tocService.tocList.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.onDestroy), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["subscribeOn"])(rxjs__WEBPACK_IMPORTED_MODULE_2__["asapScheduler"])).subscribe(function (tocList) {
              var itemCount = count(tocList, function (item) {
                return item.level !== 'h1';
              });
              _this2.type = itemCount > 0 ? _this2.isEmbedded ? itemCount > _this2.primaryMax ? 'EmbeddedExpandable' : 'EmbeddedSimple' : 'Floating' : 'None';
              _this2.tocList = tocList;
            });
          }
        }, {
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            ...
            if (!this.isEmbedded) {
              ...
              Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.tocService.activeItemIndex.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["subscribeOn"])(rxjs__WEBPACK_IMPORTED_MODULE_2__["asapScheduler"])), this.items.changes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(this.items))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.onDestroy)).subscribe(function (_ref) {
          ...
          value: function toggle() {
            var canScroll = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
          ...
          key: "prepareTitleAndToc",
          value: function prepareTitleAndToc(targetElem, docId, tocService, titleService) {
            var titleEl = targetElem.querySelector('h1');
            var needsToc = !!titleEl && !/no-?toc/i.test(titleEl.className);
            var embeddedToc = targetElem.querySelector('i-toc.embedded');
            ...
            return function () {
              tocService.reset();
              var title = ''; // Only create ToC for docs with an `<h1>` heading.
      ...
      TocComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        hostBindings: function TocComponent_HostBindings(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TocComponent_click_HostBindingHandler($event) {
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgForOf"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_7__["MatIcon"]],
        encapsulation: 2
      });
      return TocComponent;
    }();
  ...
  /***/
  function srcAppModulesMarkdownViewerServicesTocServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TocService = /*@__PURE__*/function () {
      var TocService = /*#__PURE__*/function () {
        ...
        _createClass(TocService, [{
          key: "genToc",
          value: function genToc(docElement) {
            var _this4 = this;
            ...
            var idMap = new Map();
            var tocList = headings.map(function (heading) {
              return {
                content: _this4.extractHeadingSafeHtml(heading),
                href: "".concat(docId, "#").concat(_this4.getId(heading, idMap)),
            ...
            this.scrollSpyToken.activeScrollElement$.subscribe(function (item) {
              _this4.activeItemIndex.next(item && item.index);

              _this4.activeElement$.next(item && item.element);
            });
            this.scrollSpyToken.isScrollDown$.subscribe(function (i) {
              _this4.isScrollUp = !i.isDown;
            });
          }
        }, {
          key: "reset",
          ...
          key: "extractHeadingSafeHtml",
          value: function extractHeadingSafeHtml(heading) {
            var div = this.document.createElement('div');
            div.innerHTML = heading.innerHTML;
            var anchorLinks = div.querySelectorAll('a');

            for (var i = 0; i < anchorLinks.length; i++) {
              var anchorLink = anchorLinks[i];

              if (!anchorLink.classList.contains('deep-link') && !anchorLink.classList.contains('edit-it')) {
                // this is an anchor that contains actual content that we want to keep
                // move the contents of the anchor into its parent
                var parent = anchorLink.parentNode;
          ...
          key: "findTocHeadings",
          value: function findTocHeadings(docElement) {
            var headings = docElement.querySelectorAll('h1,h2,h3');

            var skipNoTocHeadings = function skipNoTocHeadings(heading) {
          ...
          key: "resetScrollSpyInfo",
          value: function resetScrollSpyInfo() {
          ...
          value: function getId(h, idMap) {
            ...
            return id; // Map guards against duplicate id creation.

            function addToMap(key) {
              var oldCount = idMap.get(key) || 0;
              var count = oldCount + 1;
              idMap.set(key, count);
              return count === 1 ? key : "".concat(key, "-").concat(count);
            }
          }
        }]);
